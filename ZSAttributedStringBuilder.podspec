#
#  Be sure to run `pod spec lint ZSMenuView.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  自定义AttributedString；将PlainText、RTFText、RTFDText、HTMLText转为AttributedString
                   DESC
  ...
  s.source       = { :git => "https://gitee.com/safiri/ZSAttributedStringBuilder.git", :tag => "#{s.version}" }
